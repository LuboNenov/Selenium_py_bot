...
NIKE_HOME_URL = "https://www.nike.com/bg/"
...
def login(driver, email, password):
    ...
    wait_until_clickable(driver=driver, xpath="/html/body/div[1]/header/nav[1]/section[1]/div/div/ul[2]/li[1]/div/button")

    LOGGER.info("Clicking login button")
    driver.find_element_by_xpath("/html/body/div[1]/header/nav[1]/section[1]/div/div/ul[2]/li[1]/div/button").click()
...
def select_shoe_size(driver, shoe_size):
    LOGGER.info("Waiting to click size button")
    driver.find_element_by_class_name("size-grid-dropdown.size-grid-button").find_element_by_xpath("//button[text()=EU {}]").click();


def click_buy_button(driver):
    xpath = "/html/body/div[2]/div/div/div[1]/div/div[3]/div[2]/div/section[1]/div[2]/aside/div/div[2]/div/div[2]/div/button"
...
if __name__ == "__main__":
    ...
    run(driver=driver, email=args.email, password=args.password, url=args.url, shoe_size=args.shoe_size,
